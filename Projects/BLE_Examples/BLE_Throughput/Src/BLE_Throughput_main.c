...
* Version            : 2.0.0
* Date               : 26-August-2019
* Description        : Code demonstrating the BlueNRG-LP Bluetooth LE Throughput with ATT_MTU, DLE, 1/2 Mbps PHY, L2CAP COS
********************************************************************************
 ...
 * @brief This is a Throughput demo that shows how to implement some throughput tests  between two BlueNRG-LP devices using the ATT MTU size up to 247 bytes, data length extension, 1Mbps, 2Mbps PHY, L2CAP COSfeatures.
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_Throughput\\MDK-ARM\\{STEVAL-IDB011V1}\\BLE_Throughput.uvprojx</tt>
  -# Select desired configuration to build
  -# Select Project->Rebuild all target files. This will recompile and link the entire application
  -# To download the binary image, please connect an USB cable in your board (CMSIS-DAP upgrade).
  -# Select Project->Download to download the related binary image.
  -# Alternatively, open the BlueNRGx Flasher utility, put the board in bootloader mode and download the built binary image.

* \section IAR_project IAR project
  To use the project with IAR Embedded Workbench for ARM, please follow the instructions below:
  -# Open the Embedded Workbench for ARM and select File->Open->Workspace menu. 
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_Throughput\\EWARM\\{STEVAL-IDB011V1}\\BLE_Throughput.eww</tt>
  -# Select desired configuration to build
...
The following interactive options are available on Server side (open hyperteminal with 921600, 8,None,1, None):
        ...
        Press l to Enable/disable L2CAP COS txing
