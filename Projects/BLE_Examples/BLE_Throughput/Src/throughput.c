...
void print_app_flags()
{
    ...
    printf("L2CAP COS TX average throughput = %-4.1f\n", l2c_cos_tx_app_context.avg_val);
    printf("L2CAP COS RX average throughput = %-4.1f\n", l2c_cos_rx_app_context.avg_val);
#if SET_PHY 
...
void print_throughput()
    ...
    printf("%d sec: TX=%.1f, RX=%.1f, COSTX=%.1f, COSRX=%.1f",
                                    (int)(time_now / 1000),
                                    (float)tx_thr,
                                    (float)rx_thr,
                                    (float)l2c_cos_tx_thr,
                                    (float)l2c_cos_rx_thr);
