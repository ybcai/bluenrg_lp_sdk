...
int main(void)
{
  ...
  //SysCtrl_PeripheralClockCmd(CLOCK_PERIPH_PKA, DISABLE); //TBR???
  ...
  while(1) {
    ...
    default:
      ...
      BSP_COM_DeInit();//TBR
      //SysCtrl_PeripheralClockCmd(CLOCK_PERIPH_UART, DISABLE); //TBR??? 
      //SysCtrl_PeripheralClockCmd(CLOCK_PERIPH_GPIO, DISABLE); //TBR??? 
