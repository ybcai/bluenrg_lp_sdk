...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_HID_Peripheral\\MDK-ARM\\{STEVAL-IDB011V1}\\HID_Peripheral.uvprojx</tt> 
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_HID_Peripheral\\EWARM\\{STEVAL-IDB011V1}\\HID_Peripheral.eww</tt> 
  -# Select desired configuration to build
...
--------------------------------------------------------------
|      PUSH1     |      Not Used      |   Left mouse button  |
|      PUSH2     |      Not Used      |  Right mouse button  |
