 ...
 * Bluetooth LE Over-The-Air (OTA) firmware upgrade capability with the Bluetooth LE Sensor Demo.
 * NOTE: Sensor Demo variant with Bluetooth LE static stack approach is also available on BLE_SensorDemo_StaticStack.

* \section KEIL_project KEIL project
  To use the project with KEIL uVision 5 for ARM, please follow the instructions below:
  -# Open the KEIL uVision 5 for ARM and select Project->Open Project menu. 
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_SensorDemo\\MDK-ARM\\{STEVAL-IDB011V1}\\BLE_SensorDemo.uvprojx</tt> 
      <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_SensorDemo_StaticStack\\MDK-ARM\\{STEVAL-IDB011V1}\\BLE_SensorDemo_StaticStack.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_SensorDemo\\EWARM\\{STEVAL-IDB011V1}\\BLE_SensorDemo.eww</tt> 
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_SensorDemo_StaticStack\\EWARM\\{STEVAL-IDB011V1}\\BLE_SensorDemo_StaticStack.eww</tt> 
  -# Select desired configuration to build
...
------------------------------------------------------------------------------------------------------------------------------
|  PIN name  |   STEVAL-IDB011V1  |   STEVAL-IDB010V1  |   STEVAL-IDB011V1  |      STEVAL-IDB011V1     |   STEVAL-IDB011V1  |
------------------------------------------------------------------------------------------------------------------------------
...
|            |       Release      |                                      HigherApp_OTA                                      ||           Use_OTA_ServiceManager           |                LowerApp_OTA                |
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|  LED name  |   STEVAL-IDB011V1  |               STEVAL-IDB010V1              |               STEVAL-IDB011V1              |               STEVAL-IDB011V1              |               STEVAL-IDB011V1              |
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|     DL1    |      Not Used      |                  Not Used                  |                  Not Used                  |                  Not Used                  |                  Not Used                  |
|     DL2    |      Not Used      |                  Not Used                  |                  Not Used                  |                  Not Used                  |                  Not Used                  |
|     DL3    |      Error led     |   ON when OTA firmware upgrade is ongoing  |   ON when OTA firmware upgrade is ongoing  |   ON when OTA firmware upgrade is ongoing  |   ON when OTA firmware upgrade is ongoing  |
|     DL4    |      Not Used      |                  Not Used                  |                  Not Used                  |                  Not Used                  |                  Not Used                  |
|     U5     |    Activity led    |                  Not Used                  |                  Not Used                  |                  Not Used                  |                  Not Used                  |
...
|                |       Release      |              HigherApp_OTA              ||     Use_OTA_ServiceManager     |    LowerApp_OTA    |
----------------------------------------------------------------------------------------------------------------------------------------
|   BUTTON name  |   STEVAL-IDB011V1  |   STEVAL-IDB010V1  |   STEVAL-IDB011V1  |         STEVAL-IDB011V1        |   STEVAL-IDB011V1  |
----------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |      Not Used      |      Not Used      |      Not Used      |   Jump to OTA Service manager  |      Not Used      |
|      PUSH2     |      Not Used      |      Not Used      |      Not Used      |            Not Used            |      Not Used      |
|      RESET     |  Reset BlueNRG-LP  |  Reset BlueNRG-LP  |  Reset BlueNRG-LP  |        Reset BlueNRG1-LP       |  Reset BlueNRG-LP  |
...
NOTEs:
     ...
     - Sensor Demo variant with Bluetooth LE static stack approach is also available on BLE_SensorDemo_StaticStack.It also provides OTA framework (Lower and Higher Apps).
...
int main(void) 
{
  ...
  wakeupIO.IO_Mask_High_polarity = WAKEUP_PB0;
