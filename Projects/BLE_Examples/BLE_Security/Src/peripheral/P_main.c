...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
      <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_Security\\MDK-ARM\\{STEVAL-IDB011V1}\\BLE_Security.uvprojx</tt> 
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_Security\\EWARM\\{STEVAL-IDB011V1}\\BLE_Security.eww</tt> 
  -# Select desired configuration to build
...
------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   BLE disconnection  |    BLE disconnection   |   BLE disconnection  |    BLE disconnection   |
...
/* Uart RX */
static WakeupSourceConfig_TypeDef wakeupIO = {0, WAKEUP_PA8, 0};
