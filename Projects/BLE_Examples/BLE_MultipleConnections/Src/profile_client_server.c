    ...
    case SUBSTATE_INIT:
      {
        ...
        else if(num_connected_slaves < MAX_NUM_SLAVES){
          aci_gap_get_bonded_devices(0, 1, &num_of_bonded_devices, &bonded_device);
          if(num_of_bonded_devices > 0){
            ...
            if(StartAutoConnection()==BLE_STATUS_SUCCESS){
              ...
              STATE_TRANSITION(STATE_NORMAL, SUBSTATE_WAITING_CONN);
            }          
          }
        }
      }
