...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_SerialPort_Master_Slave\\MDK-ARM\\{STEVAL-IDB011V1}\\BLE_SerialPort_Master_Slave.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_SerialPort_Master_Slave\\EWARM\\{STEVAL-IDB011V1}\\BLE_SerialPort_Master_Slave.eww</tt>
  -# Select desired configuration to build
