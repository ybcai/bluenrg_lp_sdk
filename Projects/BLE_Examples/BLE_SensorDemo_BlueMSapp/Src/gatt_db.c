...
//#define HW_SENS_W2ST_SERVICE_UUID    0x00,0x00,0x00,0x00,0x00,0x01,0x11,0xe1,0x9a,0xb4,0x00,0x02,0xa5,0xd5,0xc5,0x1b//TBR???
#define HW_SENS_W2ST_SERVICE_UUID      0x1b,0xc5,0xd5,0xa5,0x02,0x00,0xb4,0x9a,0xe1,0x11,0x01,0x00,0x00,0x00,0x00,0x00

//#define ENVIRONMENTAL_W2ST_CHAR_UUID 0x00,0x00,0x00,0x00,0x00,0x01,0x11,0xe1,0xac,0x36,0x00,0x02,0xa5,0xd5,0xc5,0x1b//TBR???
...
//#define ACC_GYRO_MAG_W2ST_CHAR_UUID  0x00,0xC0,0x00,0x00,0x00,0x01,0x11,0xe1,0xac,0x36,0x00,0x02,0xa5,0xd5,0xc5,0x1b//TBR???
...
uint16_t EnvironmentalCharHandle, AccGyroMagCharHandle;
...
void aci_gatt_srv_read_event(uint16_t Connection_Handle, uint16_t Attribute_Handle, uint16_t Data_Offset)
{
    ...
    else if(Attribute_Handle == EnvironmentalCharHandle + 1)
    {
      ...
      data_len = 8;
      data_p = buff;
      //BlueMS_Environmental_Update((int32_t)(data_p *100), (int16_t)(data_t * 10)); //TBR???
    }
#if ST_OTA_FIRMWARE_UPGRADE_SUPPORT 
