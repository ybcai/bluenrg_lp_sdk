...
void device_initialization(void)
{
  ...
  //aci_gap_set_authentication_requirement //TBR??? SC_IS_NOT_SUPPORTED SC_IS_MANDATORY
  ...
  status = aci_gap_set_authentication_requirement(BONDING,MITM_PROTECTION_REQUIRED,SC_IS_MANDATORY,KEYPRESS_IS_NOT_SUPPORTED,0x07,0x10,USE_FIXED_PIN_FOR_PAIRING,123456);
  if (status != BLE_STATUS_SUCCESS) {
