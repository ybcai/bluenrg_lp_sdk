...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
      <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_Privacy\\MDK-ARM\\{STEVAL-IDB011V1}\\BLE_Privacy.uvprojx</tt> 
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_Privacy\\EWARM\\{STEVAL-IDB011V1}\\BLE_Privacy.eww</tt> 
  -# Select desired configuration to build
...
----------------------------------------------------------------
|      PUSH1     |   BLE disconnection  |   BLE disconnection  |
