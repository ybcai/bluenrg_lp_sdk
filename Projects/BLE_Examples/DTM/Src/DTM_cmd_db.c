...
typedef PACKED(struct) aci_hal_read_scheduler_information_cp0_s {
  uint8_t Scheduler_Handle;
} aci_hal_read_scheduler_information_cp0;

typedef PACKED(struct) aci_hal_read_scheduler_information_rp0_s {
  uint8_t Status;
  uint32_t Task_Priority;
  uint32_t Task_Num_Skip_Slots;
  uint32_t Task_Interval;
  uint32_t Task_Length;
} aci_hal_read_scheduler_information_rp0;

typedef PACKED(struct) aci_hal_get_ll_time_rp0_s {
  uint8_t Status;
  uint32_t Time;
} aci_hal_get_ll_time_rp0;

typedef PACKED(struct) aci_hal_set_ll_time_cp0_s {
  uint32_t Time;
} aci_hal_set_ll_time_cp0;

typedef PACKED(struct) aci_hal_set_ll_time_rp0_s {
  uint8_t Status;
} aci_hal_set_ll_time_rp0;
...
uint16_t aci_hal_set_priority_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_hal_read_scheduler_information_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_hal_get_ll_time_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_hal_set_ll_time_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_hal_set_ce_length_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
...
const hci_command_table_type hci_command_table[180] = {
  /* hci_disconnect */
  ...
  /* aci_hal_set_priority */
  {0xfc30, aci_hal_set_priority_process},
  /* aci_hal_read_scheduler_information */
  {0xfc31, aci_hal_read_scheduler_information_process},
  /* aci_hal_get_ll_time */
  {0xfc32, aci_hal_get_ll_time_process},
  /* aci_hal_set_ll_time */
  {0xfc33, aci_hal_set_ll_time_process},
  /* aci_hal_set_ce_length */
  {0xfc34, aci_hal_set_ce_length_process},
 ...
 */
/* Command len: 1 + 1 + cp0->Number_of_Sets * (sizeof(Advertising_Set_Parameters_t)) */
/* Response len: 1 */
uint16_t hci_le_set_extended_advertising_enable_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  ...
  *status = hci_le_set_extended_advertising_enable(cp0->Enable /* 1 */,
                                                   ...
                                                   Advertising_Set_Parameters /* cp0->Number_of_Sets * (sizeof(Advertising_Set_Parameters_t)) */);
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
  buffer_out[2] = output_size + 3;
  buffer_out[3] = 0x01;
 ...
 */
/* Command len: 1 + 1 + 1 + len * (sizeof(Extended_Scan_Parameters_t)) */
/* Response len: 1 */
uint16_t hci_le_set_extended_scan_parameters_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  ...
  *status = hci_le_set_extended_scan_parameters(cp0->Own_Address_Type /* 1 */,
                                                cp0->Scanning_Filter_Policy /* 1 */,
                                                cp0->Scanning_PHYs /* 1 */,
                                                Extended_Scan_Parameters /* len * (sizeof(Extended_Scan_Parameters_t)) */);
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
  buffer_out[2] = output_size + 3;
  buffer_out[3] = 0x01;
 ...
 */
/* Command len: 1 + 1 + 1 + 6 + 1 + len * (sizeof(Extended_Create_Connection_Parameters_t)) */
/* Response len: 1 */
uint16_t hci_le_extended_create_connection_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  ...
  *status = hci_le_extended_create_connection(cp0->Initiating_Filter_Policy /* 1 */,
                                              ...
                                              Extended_Create_Connection_Parameters /* len * (sizeof(Extended_Create_Connection_Parameters_t)) */);
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0F;
  buffer_out[2] = output_size + 3;
  buffer_out[4] = 0x01;
...
{
  /* Input params */
  aci_hal_set_priority_cp0 *cp0 = (aci_hal_set_priority_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  *status = aci_hal_set_priority(cp0->BLE_State /* 1 */,
                                 cp0->Connection_Handle /* 2 */,
                                 cp0->Priority_Max /* 1 */,
                                 cp0->Priority_Min /* 1 */);
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
 ...
 */
/* Command len: 1 */
/* Response len: 1 + 4 + 4 + 4 + 4 */
uint16_t aci_hal_read_scheduler_information_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  aci_hal_read_scheduler_information_cp0 *cp0 = (aci_hal_read_scheduler_information_cp0 *)(buffer_in + (0));

  int output_size = 1 + 4 + 4 + 4 + 4;
  /* Output params */
  aci_hal_read_scheduler_information_rp0 *rp0 = (aci_hal_read_scheduler_information_rp0 *) (buffer_out + 6);
  uint32_t Task_Priority = 0;
  uint32_t Task_Num_Skip_Slots = 0;
  uint32_t Task_Interval = 0;
  uint32_t Task_Length = 0;

  if (buffer_out_max_length < (1 + 4 + 4 + 4 + 4 + 6)) { return 0; }
  rp0->Status = aci_hal_read_scheduler_information(cp0->Scheduler_Handle /* 1 */,
                                                   &Task_Priority,
                                                   &Task_Num_Skip_Slots,
                                                   &Task_Interval,
                                                   &Task_Length);
  rp0->Task_Priority = Task_Priority;
  rp0->Task_Num_Skip_Slots = Task_Num_Skip_Slots;
  rp0->Task_Interval = Task_Interval;
  rp0->Task_Length = Task_Length;
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
  buffer_out[2] = output_size + 3;
  buffer_out[3] = 0x01;
...
uint16_t aci_hal_get_ll_time_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  ...
  int output_size = 1 + 4;
  /* Output params */
  aci_hal_get_ll_time_rp0 *rp0 = (aci_hal_get_ll_time_rp0 *) (buffer_out + 6);
  uint32_t Time = 0;

  if (buffer_out_max_length < (1 + 4 + 6)) { return 0; }
  rp0->Status = aci_hal_get_ll_time(&Time);
  rp0->Time = Time;
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
  buffer_out[2] = output_size + 3;
...
{
  /* Input params */
  aci_hal_set_ll_time_cp0 *cp0 = (aci_hal_set_ll_time_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  *status = aci_hal_set_ll_time(cp0->Time /* 4 */);
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
  buffer_out[2] = output_size + 3;
  buffer_out[3] = 0x01;
...
{
  /* Input params */
  aci_hal_set_ce_length_cp0 *cp0 = (aci_hal_set_ce_length_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  *status = aci_hal_set_ce_length(cp0->CE_Length /* 2 */);
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
  buffer_out[2] = output_size + 3;
  buffer_out[3] = 0x01;
 ...
 */
/* Command len: 1 + 1 + 1 + cp0->Num_of_List_Entries * (sizeof(List_Entry_t)) */
/* Response len: 1 */
uint16_t aci_gap_add_devices_to_white_and_resolving_list_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  ...
  *status = aci_gap_add_devices_to_white_and_resolving_list(cp0->Lists /* 1 */,
                                                            ...
                                                            List_Entry /* cp0->Num_of_List_Entries * (sizeof(List_Entry_t)) */);
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
  buffer_out[2] = output_size + 3;
  buffer_out[3] = 0x01;
...
void aci_gap_authorization_req_event(uint16_t Connection_Handle)
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_gap_authorization_req_event_rp0 *rp0 = (aci_gap_authorization_req_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2);
...
void aci_l2cap_sdu_data_rx_nwk_event(uint16_t Connection_Handle,
                                     ...
                                     uint8_t SDU_Data[])
{
  uint8_t buffer_out[6+ sizeof(aci_l2cap_sdu_data_rx_nwk_event_rp0)];
  /* Output params */
  ...
  buffer_out[4] = 0x07;
  buffer_out[5] = 0x08;
  send_event_2buffers(buffer_out, 6 + sizeof(aci_l2cap_sdu_data_rx_nwk_event_rp0), SDU_Data, SDU_Length, -1);
}
...
/* Event len: 1 + rp0->Num_Reports * (sizeof(Extended_Advertising_Report_t)) */
/**
