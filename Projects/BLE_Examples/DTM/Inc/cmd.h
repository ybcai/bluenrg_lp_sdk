...
#define DTM_FW_VERSION_MAJOR    1 //BlueNRG-LP SDK 1.0.0
#define DTM_FW_VERSION_MINOR    0 //BlueNRG-LP SDK 1.0.0
#define DTM_FW_VERSION_PATCH    0 //BlueNRG-LP SDK 1.0.0
