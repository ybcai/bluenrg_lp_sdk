...
/**
 * If this bit is set, then Event Write permit request is generated
 */
#define GATT_INTIMATE_AND_WAIT_FOR_APPL_AUTH        (0x02U)
/**
 * If this bit is set, then Read Permit or Read Multi Request is generated
 */
#define GATT_INTIMATE_APPL_WHEN_READ_N_WAIT         (0x04U)
