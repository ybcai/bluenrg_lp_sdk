...
* File Name          : SPI_HalfDuplex_Polling_IT_Master_main.c
...
/**
 * @file  SPI_HalfDuplex_Polling_IT_Master/SPI_HalfDuplex_Polling_IT_Master_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\SPI\\SPI_HalfDuplex_Polling_IT_Master\\MDK-ARM\\{STEVAL-IDB011V1}\\SPI_HalfDuplex_Polling_IT_Master.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\SPI\\SPI_HalfDuplex_Polling_IT_Master\\EWARM\\{STEVAL-IDB011V1}\\SPI_HalfDuplex_Polling_IT_Master.eww</tt>
  -# Select desired configuration to build
...
- \c SPI_HalfDuplex_Polling_IT_Master - Release configuration
...
|     DL3    |                 ON: error                |
|     DL4    |                 Not Used                 |
|     U5     |  Fast blinking: waiting for user action  |
...
- Connect Master board PA15 to Slave Board PA14
...
/* Includes ------------------------------------------------------------------*/
#include "SPI_HalfDuplex_Polling_IT_Master_main.h"
