...
* File Name          : UART_HyperTerminal_TxPolling_RxIT_main.c
...
/**
 * @file  UART_HyperTerminal_TxPolling_RxIT/UART_HyperTerminal_TxPolling_RxIT_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\UART\\UART_HyperTerminal_TxPolling_RxIT\\MDK-ARM\\{STEVAL-IDB011V1}\\UART_HyperTerminal_TxPolling_RxIT.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\UART\\UART_HyperTerminal_TxPolling_RxIT\\EWARM\\{STEVAL-IDB011V1}\\UART_HyperTerminal_TxPolling_RxIT.eww</tt>
  -# Select desired configuration to build
...
- \c UART_HyperTerminal_TxPolling_RxIT - UART configuration
...
---------------------------------------------------------------------------------------------
|     DL1    |                                   Not Used                                   |
|     DL2    |   it toggles each time transmission/reception of 10 characters is completed  |
|     DL3    |          ON when there is an error in transmission/reception process         |
|     DL4    |                                   Not Used                                   |
|     U5     |                                   Not Used                                   |
...
For this example the TX buffer (aTxStartMessage) is predefined and the RX buffers (aRXBufferA and aRXBufferB) size is limited to 10 data by the mean of the RXBUFFERSIZE define in the UART_HyperTerminal_TxPolling_RxIT_main.c file.
...
/* Includes ------------------------------------------------------------------*/
#include "UART_HyperTerminal_TxPolling_RxIT_main.h"
