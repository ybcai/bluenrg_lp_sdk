...
* Version            : 1.0.0
* Date               : 25-March-2019
* Description        : Transmission only example. The device sends a packet continuously in three different channels: 37, 38, 39 (with or not encryption)
********************************************************************************
 ...
 * @brief Transmission only example. The device sends a packet continuously in three different channels: 37, 38, 39.
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\RADIO\\RADIO_Beep\\MDK-ARM\\{STEVAL-IDB011V1}\\RADIO_Beep.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\RADIO\\RADIO_Beep\\EWARM\\{STEVAL-IDB011V1}\\RADIO_Beep.eww</tt>
  -# Select desired configuration to build
...
* \section Usage Usage
Transmission only example. The device sends a packet continuously in three different channels: 37, 38, 39. The device sends a packet of 16 bytes of payload and after each transmission the channel is changed.
