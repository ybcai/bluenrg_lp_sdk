...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\RADIO\\RADIO_Throughput\\MDK-ARM\\{STEVAL-IDB011V1}\\RADIO_Throughput.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\RADIO\\RADIO_Throughput\\EWARM\\{STEVAL-IDB011V1}\\RADIO_Throughput.eww</tt>
  -# Select desired configuration to build
...
@table
|            |  Bidirectional_TX  |   Unidirectional   |
--------------------------------------------------------
...
{  
  ...
  tim_prescaler = __LL_TIM_CALC_PSC(TIM_PERIPHCLK, 1000000);
  tim_period = 0xFFFF;
