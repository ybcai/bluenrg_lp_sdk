...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\\RADIO\\RADIO_RemoteControl\\MDK-ARM\\{STEVAL-IDB011V1}\\RADIO_RemoteControl.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\\RADIO\\RADIO_RemoteControl\\EWARM\\{STEVAL-IDB011V1}\\RADIO_RemoteControl.eww</tt>
  -# Select desired configuration to build
...
-----------------------------------------------------------------------------
|      PUSH1     |   Send command for blinking LED1 on the other RX device  |
|      PUSH2     |                         Not Used                         |
