...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\RADIO\\RADIO_TxRx\\MDK-ARM\\{STEVAL-IDB011V1}\\RADIO_TxRx.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\RADIO\\RADIO_TxRx\\EWARM\\{STEVAL-IDB011V1}\\RADIO_TxRx.eww</tt>
  -# Select desired configuration to build
...
@table
|            |        TX 2M       |         TX         |   TX_Use_OTA_ResetManager  |
-------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |  TX device: move to next RF channel  |  TX device: move to next RF channel  |  TX device: move to next RF channel  |
