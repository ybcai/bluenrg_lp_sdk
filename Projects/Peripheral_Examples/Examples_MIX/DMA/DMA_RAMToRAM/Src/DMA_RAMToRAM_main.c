...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\DMA\\DMA_RAMToRAM\\MDK-ARM\\{STEVAL-IDB011V1}\\DMA_RAMToRAM.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_MIX\\DMA\\DMA_RAMToRAM\\EWARM\\{STEVAL-IDB011V1}\\DMA_RAMToRAM.eww</tt>
  -# Select desired configuration to build
...
- \c DMA_RAMToRAM - Release configuration
...
-----------------------------------------------
|     DL1    |            Not Used            |
|     DL2    |    ON: transfer is complete    |
|     DL3    |   ON: Error_Handler is called  |
|     DL4    |            Not Used            |
|     U5     |       ON: transfer error       |
