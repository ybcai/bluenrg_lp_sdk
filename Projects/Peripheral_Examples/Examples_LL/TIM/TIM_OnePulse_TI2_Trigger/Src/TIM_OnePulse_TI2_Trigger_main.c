...
* File Name          : TIM_OnePulse_TI2_Trigger_main.c
...
/**
 * @file  TIM_OnePulse_TI2_Trigger/TIM_OnePulse_TI2_Trigger_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\TIM\\TIM_OnePulse_TI2_Trigger\\MDK-ARM\\{STEVAL-IDB011V1}\\TIM_OnePulse_TI2_Trigger.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\TIM\\TIM_OnePulse_TI2_Trigger\\EWARM\\{STEVAL-IDB011V1}\\TIM_OnePulse_TI2_Trigger.eww</tt>
  -# Select desired configuration to build
...
- \c TIM_OnePulse_TI2_Trigger - Release configuration
...
---------------------------------------------------------------------------
|     DL1    |                          Not Used                          |
|     DL2    |  On: signal generation on TIM1 CH2 - Slow blinking: error  |
|     DL3    |                          Not Used                          |
|     DL4    |                          Not Used                          |
|     U5     |                          Not Used                          |
...
/* Includes ------------------------------------------------------------------*/
#include "TIM_OnePulse_TI2_Trigger_main.h"
...
int main(void)
{
  ...
  */
  ...
  /* Configure the timer in external clock mode 1 SMS=111 (IMx_SMCR) */
  ...
  LL_TIM_SetPrescaler(TIM1, __LL_TIM_CALC_PSC(TIM_PERIPHCLK, 2000));
  
  /* Set the capture/compare register to get a pulse delay of 2s (2000000 us)*/
  LL_TIM_OC_SetCompareCH1(TIM1, __LL_TIM_CALC_DELAY(TIM_PERIPHCLK, LL_TIM_GetPrescaler(TIM1), 2000000));
  
  /* Set the autoreload register to get a pulse length of 3s (3000000 us)*/
  LL_TIM_SetAutoReload(TIM1, __LL_TIM_CALC_PULSE(TIM_PERIPHCLK, LL_TIM_GetPrescaler(TIM1), 2000000, 3000000));
  ...
  printf("TIM1 generates a positive pulse of 3 s after a delay of 2 s. \n\r");
