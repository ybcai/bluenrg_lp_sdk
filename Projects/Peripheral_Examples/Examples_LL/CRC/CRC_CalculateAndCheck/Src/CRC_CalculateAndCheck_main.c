...
* File Name          : CRC_CalculateAndCheck_main.c
...
/**
 * @file  CRC_CalculateAndCheck/CRC_CalculateAndCheck_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\CRC\\CRC_CalculateAndCheck\\MDK-ARM\\{STEVAL-IDB011V1}\\CRC_CalculateAndCheck.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\\Projects\\Peripheral_Examples\\Examples_LL\\CRC\\CRC_CalculateAndCheck\\EWARM\\{STEVAL-IDB011V1}\\CRC_CalculateAndCheck.eww</tt>
  -# Select desired configuration to build
...
- \c CRC_CalculateAndCheck - Release configuration
...
-------------------------------------------------------------
|     DL1    |                   Not Used                   |
|     DL2    |  ON: right CRC value - Slow blinking: error  |
|     DL3    |                   Not Used                   |
|     DL4    |                   Not Used                   |
|     U5     |                   Not Used                   |
...
/* Includes ------------------------------------------------------------------*/
#include "CRC_CalculateAndCheck_main.h"
