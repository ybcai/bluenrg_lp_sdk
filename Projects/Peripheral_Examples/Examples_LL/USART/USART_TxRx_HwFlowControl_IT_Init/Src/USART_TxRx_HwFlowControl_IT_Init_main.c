...
* File Name          : USART_TxRx_HwFlowControl_IT_Init_main.c
...
/**
 * @file  USART_TxRx_HwFlowControl_IT_Init/USART_TxRx_HwFlowControl_IT_Init_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\USART\\USART_TxRx_HwFlowControl_IT_Init\\MDK-ARM\\{STEVAL-IDB011V1}\\USART_TxRx_HwFlowControl_IT_Init.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\USART\\USART_TxRx_HwFlowControl_IT_Init\\EWARM\\{STEVAL-IDB011V1}\\USART_TxRx_HwFlowControl_IT_Init.eww</tt>
  -# Select desired configuration to build
...
- \c USART_TxRx_HwFlowControl_IT_Init - Release configuration
...
-------------------------------------------------------------------------------------------------------------
|     DL1    |                                           Not Used                                           |
|     DL2    |   ON: OK - Toggle: Specific value is received from the HyperTerminal - Slow blinking: error  |
|     DL3    |                                           Not Used                                           |
|     DL4    |                                           Not Used                                           |
|     U5     |                                           Not Used                                           |
...
/* Includes */
#include "USART_TxRx_HwFlowControl_IT_Init_main.h"
