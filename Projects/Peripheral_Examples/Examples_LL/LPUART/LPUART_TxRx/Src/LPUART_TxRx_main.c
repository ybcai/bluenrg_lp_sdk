...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\LPUART\\LPUART_TxRx\\MDK-ARM\\{STEVAL-IDB011V1}\\LPUART_TxRx.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\LPUART\\LPUART_TxRx\\EWARM\\{STEVAL-IDB011V1}\\LPUART_TxRx.eww</tt>
  -# Select desired configuration to build
...
- \c LPUART_TxRx - Release configuration
...
-------------------------------------------------------------------------------------------------------------------
|     DL1    |                                              Not Used                                              |
|     DL2    |  ON: specific value is received (s or S) - OFF: specific value is received - Slow blinking: error  |
|     DL3    |                                              Not Used                                              |
|     DL4    |                                              Not Used                                              |
|     U5     |                                              Not Used                                              |
