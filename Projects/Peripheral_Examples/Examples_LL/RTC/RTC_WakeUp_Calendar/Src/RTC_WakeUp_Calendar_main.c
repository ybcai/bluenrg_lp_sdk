...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_WakeUp_Calendar\\MDK-ARM\\{STEVAL-IDB011V1}\\RTC_WakeUp_Calendar.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_WakeUp_Calendar\\EWARM\\{STEVAL-IDB011V1}\\RTC_WakeUp_Calendar.eww</tt>
  -# Select desired configuration to build
...
-----------------------------------------------------------------------------------------------
|     DL1    |                                    Not Used                                    |
|     DL2    |  ON; RTC configuration is done correctly; toggling: system generates an error  |
|     DL3    |                                    Not Used                                    |
|     DL4    |                                    Not Used                                    |
|     U5     |                                    Not Used                                    |
...
#error "No Low Speed Crystal definition!!!"
  ...
  LL_PWR_EnablePDA(LL_PWR_PUPD_IO2|LL_PWR_PUPD_IO3|LL_PWR_PUPD_IO4|LL_PWR_PUPD_IO5|LL_PWR_PUPD_IO6|LL_PWR_PUPD_IO7|LL_PWR_PUPD_IO10|LL_PWR_PUPD_IO11|LL_PWR_PUPD_IO12|LL_PWR_PUPD_IO13|LL_PWR_PUPD_IO14|LL_PWR_PUPD_IO15);
