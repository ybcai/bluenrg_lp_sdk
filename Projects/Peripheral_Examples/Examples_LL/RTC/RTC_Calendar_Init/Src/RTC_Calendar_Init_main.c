...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_Calendar_Init\\MDK-ARM\\{STEVAL-IDB011V1}\\RTC_Calendar_Init.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_Calendar_Init\\EWARM\\{STEVAL-IDB011V1}\\RTC_Calendar_Init.eww</tt>
  -# Select desired configuration to build
...
#define TIMEOUT_VALUE          ((uint32_t)5000)  /* 5 s */
