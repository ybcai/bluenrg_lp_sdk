...
* File Name          : RTC_ExitStandbyWithWakeUpTimer_Init_main.c
...
/**
 * @file  RTC_ExitStandbyWithWakeUpTimer_Init/RTC_ExitStandbyWithWakeUpTimer_Init_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_ExitStandbyWithWakeUpTimer_Init\\MDK-ARM\\{STEVAL-IDB011V1}\\RTC_ExitStandbyWithWakeUpTimer_Init.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_ExitStandbyWithWakeUpTimer_Init\\EWARM\\{STEVAL-IDB011V1}\\RTC_ExitStandbyWithWakeUpTimer_Init.eww</tt>
  -# Select desired configuration to build
...
---------------------------------------------------------------------------------------------------------------------------
|     DL1    |                                                  Not Used                                                  |
|     DL2    |   On: system is resumed from standby mode;  fast blinking: wait fpr User push-buton; slow blinking: error  |
|     DL3    |                                                  Not Used                                                  |
|     DL4    |                                                  Not Used                                                  |
|     U5     |                                                  Not Used                                                  |
...
/* Includes ------------------------------------------------------------------*/
#include "RTC_ExitStandbyWithWakeUpTimer_Init_main.h"
...
int main(void)
{
  ...
  printf("Waiting for user-button press.\n\r");
