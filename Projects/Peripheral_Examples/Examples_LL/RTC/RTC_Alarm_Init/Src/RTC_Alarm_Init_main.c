...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_Alarm_Init\\MDK-ARM\\{STEVAL-IDB011V1}\\RTC_Alarm_Init.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_Alarm_Init\\EWARM\\{STEVAL-IDB011V1}\\RTC_Alarm_Init.eww</tt>
  -# Select desired configuration to build
...
-----------------------------------------------------------------------------------
|     DL1    |                              Not Used                              |
|     DL2    |   ON: RTC Alarm Interrupt is generated correctly; Blinking: error  |
|     DL3    |                              Not Used                              |
|     DL4    |                              Not Used                              |
|     U5     |                              Not Used                              |
