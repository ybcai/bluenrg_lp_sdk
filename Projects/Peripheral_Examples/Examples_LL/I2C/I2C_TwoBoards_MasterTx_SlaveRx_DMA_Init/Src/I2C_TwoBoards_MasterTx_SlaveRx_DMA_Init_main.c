...
* File Name          : I2C_TwoBoards_MasterTx_SlaveRx_DMA_Init_main.c
...
/**
 * @file  I2C_TwoBoards_MasterTx_SlaveRx_DMA_Init/I2C_TwoBoards_MasterTx_SlaveRx_DMA_Init_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\I2C\\I2C_TwoBoards_MasterTx_SlaveRx_DMA_Init\\MDK-ARM\\{STEVAL-IDB011V1}\\I2C_TwoBoards_MasterTx_SlaveRx_DMA_Init.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\I2C\\I2C_TwoBoards_MasterTx_SlaveRx_DMA_Init\\EWARM\\{STEVAL-IDB011V1}\\I2C_TwoBoards_MasterTx_SlaveRx_DMA_Init.eww</tt>
  -# Select desired configuration to build
...
|     DL2    |   ON: Data reception is OK - Slow blinking: error  |   ON: Data reception is OK - Fast blinking: wait for user-button press - Slow blinking: error  |
...
----------------------------------------------------------------------------------------------------
|      PUSH1     |  Start of the communication by Master  |  Start of the communication by Master  |
...
The user can choose between Master and Slave through "#define SLAVE_BOARD" in the "I2C_TwoBoards_MasterTx_SlaveRx_DMA_Init_main.h" file:
