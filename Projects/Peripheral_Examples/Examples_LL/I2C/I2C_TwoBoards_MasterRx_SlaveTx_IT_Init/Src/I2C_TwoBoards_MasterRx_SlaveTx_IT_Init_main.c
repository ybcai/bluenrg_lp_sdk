...
* File Name          : I2C_TwoBoards_MasterRx_SlaveTx_IT_Init_main.c
...
/**
 * @file  I2C_TwoBoards_MasterRx_SlaveTx_IT_Init/I2C_TwoBoards_MasterRx_SlaveTx_IT_Init_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\I2C\\I2C_TwoBoards_MasterRx_SlaveTx_IT_Init\\MDK-ARM\\{STEVAL-IDB011V1}\\I2C_TwoBoards_MasterRx_SlaveTx_IT_Init.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\I2C\\I2C_TwoBoards_MasterRx_SlaveTx_IT_Init\\EWARM\\{STEVAL-IDB011V1}\\I2C_TwoBoards_MasterRx_SlaveTx_IT_Init.eww</tt>
  -# Select desired configuration to build
...
@table
|            |                    Slave_board                   |                                         Master_board                                         |
----------------------------------------------------------------------------------------------------------------------------------------------------------------
|  LED name  |                  STEVAL-IDB011V1                 |                                        STEVAL-IDB011V1                                       |
----------------------------------------------------------------------------------------------------------------------------------------------------------------
|     DL1    |                     Not Used                     |                                           Not Used                                           |
|     DL2    |  ON: communication is OK - Slow blinking: error  |  ON: communication is OK - Fast blinking: wait for user-button press - Slow blinking: error  |
...
--------------------------------------------------------------------------------
|      PUSH1     |      Not Used      |  Start of the communication by Master  |
...
The user can choose between Master and Slave through "#define SLAVE_BOARD" in the "I2C_TwoBoards_MasterRx_SlaveTx_IT_Init_main.h" file:
...
in the "I2C_TwoBoards_MasterRx_SlaveTx_IT_Init_main.h" file:
- Comment "#define SLAVE_BOARD" to select Master board.
- Uncomment "#define SLAVE_BOARD" to select Slave board.
...
BLUENRG_LP Set-up
- master I2C2_SCL  PA.13 : connected to slave I2C2_SCL PA.13
- master I2C2_SDA  PA.14 : connected to slave I2C2_SDA PA.14
...
/* Includes ------------------------------------------------------------------*/
#include "I2C_TwoBoards_MasterRx_SlaveTx_IT_Init_main.h"
