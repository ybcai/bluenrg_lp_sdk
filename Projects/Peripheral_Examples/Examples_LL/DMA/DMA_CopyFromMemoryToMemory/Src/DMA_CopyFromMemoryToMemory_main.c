...
* File Name          : DMA_CopyFromMemoryToMemory_main.c
...
/**
 * @file DMA_CopyFromMemoryToMemory/DMA_CopyFromMemoryToMemory_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\DMA\\DMA_CopyFromMemoryToMemory\\MDK-ARM\\{STEVAL-IDB011V1}\\DMA_CopyFromMemoryToMemory.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\DMA\\DMA_CopyFromMemoryToMemory\\EWARM\\{STEVAL-IDB011V1}\\DMA_CopyFromMemoryToMemory.eww</tt>
  -# Select desired configuration to build
...
- \c DMA_CopyFromMemoryToMemory - Release configuration
...
/* Includes ------------------------------------------------------------------*/
#include "DMA_CopyFromMemoryToMemory_main.h"

/** @addtogroup BlueNRG_LP_LL_Examples
  * @{
  */

/** @addtogroup DMA_CopyFromMemoryToMemory
  * @{
  */
