...
* File Name          : SPI_OneBoard_HalfDuplex_IT_Init_main.c
...
/**
 * @file  SPI_OneBoard_HalfDuplex_IT_Init/SPI_OneBoard_HalfDuplex_IT_Init_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\SPI\\SPI_OneBoard_HalfDuplex_IT_Init\\MDK-ARM\\{STEVAL-IDB011V1}\\SPI_OneBoard_HalfDuplex_IT_Init.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\SPI\\SPI_OneBoard_HalfDuplex_IT_Init\\EWARM\\{STEVAL-IDB011V1}\\SPI_OneBoard_HalfDuplex_IT_Init.eww</tt>
  -# Select desired configuration to build
...
- \c SPI_OneBoard_HalfDuplex_IT_Init - Release configuration
...
/* Includes ------------------------------------------------------------------*/
#include "SPI_OneBoard_HalfDuplex_IT_Init_main.h"
...
{
  checkSPIclearInterruptRX = LL_SPI_IsActiveFlag_RXNE(SPI2);
  if(checkSPIclearInterruptRX){
  ...
  while(checkSPIclearInterruptRX == 1){
    checkSPIclearInterruptRX = LL_SPI_IsActiveFlag_RXNE(SPI2);
  }
