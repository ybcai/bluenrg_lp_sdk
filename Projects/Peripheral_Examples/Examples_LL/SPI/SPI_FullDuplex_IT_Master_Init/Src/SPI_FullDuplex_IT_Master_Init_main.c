...
* File Name          : SPI_FullDuplex_IT_Master_Init_main.c
...
/**
 * @file  SPI_FullDuplex_IT_Master_Init/SPI_FullDuplex_IT_Master_Init_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\SPI\\SPI_FullDuplex_IT_Master_Init\\MDK-ARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_IT_Master_Init.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\SPI\\SPI_FullDuplex_IT_Master_Init\\EWARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_IT_Master_Init.eww</tt>
  -# Select desired configuration to build
...
- \c SPI_FullDuplex_IT_Master_Init - Release configuration
...
- Connect Master board PA05 to Slave Board PA05
- Connect Master board PA07 to Slave Board PA07
- Connect Master board PA12 to Slave Board PA12
...
static void MX_SPI_Master_Init(void)
{
  ...
  LL_GPIO_Init(GPIO_PORT_MASTER, &GPIO_InitStruct);
...
void WaitForUserButtonPress(void)
{
  ...
  while ( LL_GPIO_IsInputPinSet(USER_BUTTON_GPIO_PORT, USER_BUTTON_PIN) == USER_BUTTON_SETTED )
  {
    LL_GPIO_TogglePin(LED2_GPIO_PORT, LED2_PIN);
