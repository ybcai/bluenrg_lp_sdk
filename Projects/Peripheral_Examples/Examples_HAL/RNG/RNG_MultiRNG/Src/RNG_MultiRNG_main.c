...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\RNG\\RNG_MultiRNG\\MDK-ARM\\{STEVAL-IDB011V1}\\RNG_MultiRNG.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\RNG\\RNG_MultiRNG\\EWARM\\{STEVAL-IDB011V1}\\RNG_MultiRNG.eww</tt>
  -# Select desired configuration to build
...
- \c RNG_MultiRNG - Release configuration
...
-----------------------------------------------------------------------------
|     DL1    |                           Not Used                           |
|     DL2    |   Fast blinking: wait for user action; Slow blinking: error  |
|     DL3    |                           Not Used                           |
|     DL4    |                           Not Used                           |
|     U5     |                           Not Used                           |
