...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\HAL\\HAL_TimeBase_TIM\\MDK-ARM\\{STEVAL-IDB011V1}\\HAL_TimeBase_TIM.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\HAL\\HAL_TimeBase_TIM\\EWARM\\{STEVAL-IDB011V1}\\HAL_TimeBase_TIM.eww</tt>
  -# Select desired configuration to build
...
- \c HAL_TimeBase_TIM - Release configuration
...
---------------------------------------------------------------------------------------
|     DL1    |                                Not Used                                |
|     DL2    |  Blinking: tick increment is on - Toggle: tick increment is suspended  |
|     DL3    |                                Not Used                                |
|     DL4    |                                Not Used                                |
|     U5     |                                Not Used                                |
