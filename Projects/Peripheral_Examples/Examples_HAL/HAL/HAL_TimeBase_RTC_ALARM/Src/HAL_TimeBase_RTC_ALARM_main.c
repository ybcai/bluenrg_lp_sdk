...
* File Name          : HAL_TimeBase_RTC_ALARM_main.c
...
/**
 * @file  HAL_TimeBase_RTC_ALARM/HAL_TimeBase_RTC_ALARM_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\HAL\\HAL_TimeBase_RTC_ALARM\\MDK-ARM\\{STEVAL-IDB011V1}\\HAL_TimeBase_RTC_ALARM.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\HAL\\HAL_TimeBase_RTC_ALARM\\EWARM\\{STEVAL-IDB011V1}\\HAL_TimeBase_RTC_ALARM.eww</tt>
  -# Select desired configuration to build
...
- \c HAL_TimeBase_RTC_ALARM - Release configuration
...
---------------------------------------------------------------
|      PUSH1     |  it is used to suspend the tick increment  |
|      PUSH2     |   it is used to resume the tick increment  |
...
This implementation will overwrite native implementation in bluenrg_lp_hal.c and so user functions will be invoked instead when called.
...
When user pushes the User push-button (PUSH1), the Tick is suspended.
When user pushes the User push-button (PUSH2), the Tick is resumed.
