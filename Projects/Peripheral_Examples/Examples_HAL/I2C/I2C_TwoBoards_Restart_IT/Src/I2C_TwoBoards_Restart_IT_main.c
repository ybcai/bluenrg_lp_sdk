...
* File Name          : I2C_TwoBoards_Restart_IT_main.c
...
/**
 * @file  I2C_TwoBoards_Restart_IT/I2C_TwoBoards_Restart_IT_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\I2C\\I2C_TwoBoards_Restart_IT\\MDK-ARM\\{STEVAL-IDB011V1}\\I2C_TwoBoards_Restart_IT.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\\Projects\\Peripheral_Examples\\Examples_HAL\\I2C\\I2C_TwoBoards_Restart_IT\\EWARM\\{STEVAL-IDB011V1}\\I2C_TwoBoards_Restart_IT.eww</tt>
  -# Select desired configuration to build
...
|     DL2    |   ON: the reception process is complete  |   ON:the transmission process is complete - Blinking: waiting for User action  |
...
------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |      Not Used      |   1stPush:Master starts the transmission process - 2ndPush: Master starts the reception process  |
...
The project is splitted in two parts the Master Board and the Slave Board
 ...
 - Slave Board
   ...
   in Slave mode.
The user can choose between Master and Slave through "#define MASTER_BOARD" in the "I2C_TwoBoards_Restart_IT_main.c" file.
...
- Connect I2C_SCL line of Master board (PA13) to I2C_SCL line of Slave Board (PA13).
- Connect I2C_SDA line of Master board (PA14) to I2C_SDA line of Slave Board (PA14).
...
/* Includes ------------------------------------------------------------------*/
#include "I2C_TwoBoards_Restart_IT_main.h"
...
//  HAL_I2CEx_EnableFastModePlus(I2C_FASTMODEPLUS_PA0);
//  HAL_I2CEx_EnableFastModePlus(I2C_FASTMODEPLUS_PA1);
}   
