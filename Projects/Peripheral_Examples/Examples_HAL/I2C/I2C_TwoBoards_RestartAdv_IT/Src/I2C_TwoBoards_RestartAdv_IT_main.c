...
* File Name          : I2C_TwoBoards_RestartAdv_IT_main.c
...
/**
 * @file  I2C_TwoBoards_RestartAdv_IT/I2C_TwoBoards_RestartAdv_IT_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\I2C\\I2C_TwoBoards_RestartAdv_IT\\MDK-ARM\\{STEVAL-IDB011V1}\\I2C_TwoBoards_RestartAdv_IT.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\I2C\\I2C_TwoBoards_RestartAdv_IT\\EWARM\\{STEVAL-IDB011V1}\\I2C_TwoBoards_RestartAdv_IT.eww</tt>
  -# Select desired configuration to build
...
The project is splitted in two parts the Master Board and the Slave Board
 ...
 - Slave Board
   ...
   in Slave mode.
The user can choose between Master and Slave through "#define MASTER_BOARD" in the "I2C_TwoBoards_RestartAdv_IT_main.c" file.
...
/* Includes ------------------------------------------------------------------*/
#include "I2C_TwoBoards_RestartAdv_IT_main.h"
...
#endif
  /* BLUENRG_LP HAL library initialization:
