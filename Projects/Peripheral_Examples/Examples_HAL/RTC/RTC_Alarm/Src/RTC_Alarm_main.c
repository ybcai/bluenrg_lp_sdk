...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\RTC\\RTC_Alarm\\MDK-ARM\\{STEVAL-IDB011V1}\\RTC_Alarm.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\RTC\\RTC_Alarm\\EWARM\\{STEVAL-IDB011V1}\\RTC_Alarm.eww</tt>
  -# Select desired configuration to build
...
The User push-button (PUSH1) is used to set to 23:59:50 and so the Alarm must be generated on 00:00:00. 
