...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\FLASH\\FLASH_EraseProgram\\MDK-ARM\\{STEVAL-IDB011V1}\\FLASH_EraseProgram.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\FLASH\\FLASH_EraseProgram\\EWARM\\{STEVAL-IDB011V1}\\FLASH_EraseProgram.eww</tt>
  -# Select desired configuration to build
...
- \c FLASH_EraseProgram - Release configuration
...
---------------------------------------------------------------------------------------------
|     DL1    |                                   Not Used                                   |
|     DL2    |  ON: no errors after data programming - Fast Blinking: wait for user action  |
|     DL3    |                            ON: program is running                            |
|     DL4    |                                   Not Used                                   |
