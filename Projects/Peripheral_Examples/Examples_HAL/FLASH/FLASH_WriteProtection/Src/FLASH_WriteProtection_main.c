...
* File Name          : FLASH_WriteProtection_main.c
...
/**
 * @file  FLASH_WriteProtection/FLASH_WriteProtection_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\Examples_HAL\\FLASH\FLASH_WriteProtection\\MDK-ARM\\{STEVAL-IDB011V1}\\FLASH_WriteProtection.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\FLASH\\FLASH_WriteProtection\\EWARM\\{STEVAL-IDB011V1}\\FLASH_WriteProtection.eww/</tt>
  -# Select desired configuration to build
...
- \c FLASH_WriteProtection - Release configuration
...
-------------------------------------------------------------------------------------------------------------
|     DL1    |                                           Not Used                                           |
|     DL2    |   ON: there are data writing into the protected pages - Fast Blinking: wait for user action  |
|     DL3    |               ON: the page protection doesn't allow to write into the page 126               |
|     DL4    |                                           Not Used                                           |
|     U5     |                               ON: errors after data programming                              |
...
-------------------------------------------------------
|      PUSH1     |   it is used to start application  |
|      PUSH2     |              Not Used              |
...
/* Includes ------------------------------------------------------------------*/
#include "FLASH_WriteProtection_main.h"
