...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\CRC\\CRC_Example\\MDK-ARM\\{STEVAL-IDB011V1}\\CRC_Example.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\CRC\\CRC_Example\\EWARM\\{STEVAL-IDB011V1}\\CRC_Example.eww</tt>
  -# Select desired configuration to build
...
- \c CRC_Example - Release configuration
...
---------------------------------------------------------------------------------------------
|     DL1    |                                   Not Used                                   |
|     DL2    |                      ON: CRC is OK - Blinking: CRC error                     |
|     DL3    |   ON: incorrect CRC value is calculated or there is an initialization error  |
|     DL4    |                                   Not Used                                   |
|     U5     |                                   Not Used                                   |
