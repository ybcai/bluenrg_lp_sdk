...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\GPIO\\GPIO_IOToggle\\MDK-ARM\\{STEVAL-IDB011V1}\\GPIO_IOToggle.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\GPIO\\GPIO_IOToggle\\EWARM\\{STEVAL-IDB011V1}\\GPIO_IOToggle.eww</tt>
  -# Select desired configuration to build
...
- \c GPIO_IOToggle - Release configuration
...
-----------------------------------------------
|     DL1    |            Not Used            |
|     DL2    |  blinking: program is running  |
|     DL3    |  blinking: program is running  |
|     DL4    |            Not Used            |
|     U5     |            Not Used            |
