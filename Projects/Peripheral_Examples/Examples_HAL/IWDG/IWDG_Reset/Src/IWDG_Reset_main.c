...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\IWDG\\IWDG_Reset\\MDK-ARM\\{STEVAL-IDB011V1}\\IWDG_Reset.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\IWDG\\IWDG_Reset\\EWARM\\{STEVAL-IDB011V1}\\IWDG_Reset.eww</tt>
  -# Select desired configuration to build
...
- \c IWDG_Reset - Release configuration
...
The IWDG reload counter is refreshed each 990 ms in the main program infinite loop to prevent a IWDG reset.
  
LED2 is toggling each 990 ms indicating that the program is running.
