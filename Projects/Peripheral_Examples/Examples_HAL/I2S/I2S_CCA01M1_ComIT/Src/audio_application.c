...
uint32_t Switch_Demo(void)
{
  ...
  case 1:
    { 
      /* Write 1 to the  Register STA350BW_MUTE, Field MMUTE, Master Mute to mute the system */
  ...
  case 2:
    {
      /* Write 0 to the  Register STA350BW_MUTE, Field MMUTE, Master Mute to unMute the system */
