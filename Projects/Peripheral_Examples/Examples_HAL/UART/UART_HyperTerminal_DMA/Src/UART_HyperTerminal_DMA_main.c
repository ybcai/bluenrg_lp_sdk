...
* File Name          : UART_HyperTerminal_DMA_main.c
...
/**
 * @file  UART_HyperTerminal_DMA/UART_HyperTerminal_DMA_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\UART\\UART_HyperTerminal_DMA\\MDK-ARM\\{STEVAL-IDB011V1}\\UART_HyperTerminal_DMA.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\UART\\UART_HyperTerminal_DMA\\EWARM\\{STEVAL-IDB011V1}\\UART_HyperTerminal_DMA.eww</tt>
  -# Select desired configuration to build
...
- \c UART_HyperTerminal_DMA - Release configuration
...
For this example the TxBuffer(aTxStartMessage) is predefined and the RxBuffer (aRxBuffer) size is limited to 10 data by the mean of the RXBUFFERSIZE define in the UART_HyperTerminal_DMA_main.c file.
...
USARTx/UARTx instance used and associated resources can be updated in "UART_HyperTerminal_DMA_main.h"
...
/* Includes ------------------------------------------------------------------*/
#include "UART_HyperTerminal_DMA_main.h"
