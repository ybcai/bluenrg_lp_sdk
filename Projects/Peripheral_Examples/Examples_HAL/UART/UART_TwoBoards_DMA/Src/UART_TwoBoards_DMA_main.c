...
* File Name          : UART_TwoBoards_DMA_main.c
...
/**
 * @file  UART_TwoBoards_DMA/UART_TwoBoards_DMA_main.c
 * @brief UART transmission (transmit/receive) in DMA mode between two boards.
 *
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\UART\\UART_TwoBoards_DMA\\MDK-ARM\\{STEVAL-IDB011V1}\\UART_TwoBoards_DMA.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\UART\\UART_TwoBoards_DMA\\EWARM\\{STEVAL-IDB011V1}\\UART_TwoBoards_DMA.eww</tt>
  -# Select desired configuration to build
...
WARNING: as both boards do not behave the same way, "TRANSMITTER_BOARD" compilation switch is defined in /Src/UART_TwoBoards_DMA_main.c and must be enabled at compilation time before loading the executable in the board that first transmits then receives.
...
USARTx/UARTx instance used and associated resources can be updated in "UART_TwoBoards_DMA_main.h" file depending hardware configuration used.

When the parity is enabled, the computed parity is inserted at the MSB position of the transmitted data.

As both boards do not behave the same way, "#define TRANSMITTER_BOARD" compilation switch is defined in /Src/UART_TwoBoards_DMA_main.c and must be enabled at compilation time before loading the executable in the board that first transmits then receives.
The receiving then transmitting board needs to be loaded with an executable software obtained with TRANSMITTER_BOARD disabled. 
...
/* Includes ------------------------------------------------------------------*/
#include "UART_TwoBoards_DMA_main.h"
