...
* File Name          : UART_HyperTerminal_HwFlowControl_IT_main.c
...
/**
 * @file  UART_HyperTerminal_IT/UART_HyperTerminal_HwFlowControl_IT.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\UART\\UART_HyperTerminal_IT\\MDK-ARM\\{STEVAL-IDB011V1}\\UART_HyperTerminal_IT.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\UART\\UART_HyperTerminal_IT\\EWARM\\{STEVAL-IDB011V1}\\UART_HyperTerminal_IT.eww</tt>
  -# Select desired configuration to build
...
- \c UART_HyperTerminal_HwFlowControl_IT - Release configuration
...
-------------------------------------------------------------------
|     DL1    |                      Not Used                      |
|     DL2    |  ON: if transmission/reception is complete and OK  |
|     DL3    |                      ON: error                     |
|     DL4    |                      Not Used                      |
|     U5     |                      Not Used                      |
...
For this example the TxBuffer (aTxStartMessage) is predefined and the RxBuffer (aRxBuffer) size is limited to 10 data by the mean of the RXBUFFERSIZE define in the UART_HyperTerminal_HwFlowControl_IT_main.c file.
...
/* Includes ------------------------------------------------------------------*/
#include "UART_HyperTerminal_HwFlowControl_IT_main.h"
...
uint8_t aTxStartMessage[] = "\n\r ****UART-Hyperterminal communication based on IT using hardware flow control****\n\r Enter 10 characters using keyboard :\n\r";
