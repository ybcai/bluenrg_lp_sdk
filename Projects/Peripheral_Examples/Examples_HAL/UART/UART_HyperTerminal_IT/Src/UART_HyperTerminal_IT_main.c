...
- \c UART_HyperTerminal_IT - Release configuration
...
For this example the TxBuffer (aTxStartMessage) is predefined and the RxBuffer (aRxBuffer) size is limited to 10 data by the mean of the RXBUFFERSIZE define in the UART_HyperTerminal_IT_main.c file.
...
USARTx/UARTx instance used and associated resources can be updated in "UART_HyperTerminal_IT_main.h" file depending hardware configuration used.
