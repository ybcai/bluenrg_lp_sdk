...
* File Name          : UART_TwoBoards_Polling_main.c
...
/**
 * @file  UART_TwoBoards_Polling/UART_TwoBoards_Polling_main.c
 * @brief UART transmission (transmit/receive) in Polling mode between two boards.
 *
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\UART\\UART_TwoBoards_Polling\\MDK-ARM\\{STEVAL-IDB011V1}\\UART_TwoBoards_Polling.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\UART\\UART_TwoBoards_Polling\\EWARM\\{STEVAL-IDB011V1}\\UART_TwoBoards_Polling.eww</tt>
  -# Select desired configuration to build
...
|     DL3    |  ON: if transmission/reception is complete and OK  |                                                   Not Used                                                   |
...
Then, board 1 sends in polling mode a message to board 2 that sends it back to board 1 in polling mode as well.
Finally, board 1 and 2 compare the received message to that sent.
If the messages are the same, the test passes.


WARNING: as both boards do not behave the same way, "TRANSMITTER_BOARD" compilation switch is defined in UART_TwoBoards_Polling_main.c and must be enabled at compilation time before loading the executable in the board that first transmits then receives.
...
- While board 1 is waiting for the user to press the User push-button (PUSH1), its LED2 is
...
USARTx/UARTx instance used and associated resources can be updated in "UART_TwoBoards_Polling_main.h" file depending hardware configuration used.
...
uint8_t aTxBuffer[] = " **** UART_TwoBoards_Polling ****  **** UART_TwoBoards_Polling ****  **** UART_TwoBoards_Polling **** ";
