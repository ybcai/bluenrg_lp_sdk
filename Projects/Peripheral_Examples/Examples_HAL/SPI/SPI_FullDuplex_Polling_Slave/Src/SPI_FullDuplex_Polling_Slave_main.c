...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\SPI\\SPI_FullDuplex_Polling_Slave\\MDK-ARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_Polling_Slave.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\SPI\\SPI_FullDuplex_Polling_Slave\\EWARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_Polling_Slave.eww</tt>
  -# Select desired configuration to build
...
|     DL4    |                 Not Used                 |
|     U5     |   ON: transmission process is complete.  |
