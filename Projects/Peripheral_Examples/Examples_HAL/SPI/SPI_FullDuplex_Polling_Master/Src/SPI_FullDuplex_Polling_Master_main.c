...
* File Name          : SPI_FullDuplex_Polling_Master_main.c
...
/**
 * @file  SPI_FullDuplex_Polling_Master/SPI_FullDuplex_Polling_Master_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\SPI\\SPI_FullDuplex_Polling_Master\\MDK-ARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_Polling_Master.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\SPI\\SPI_FullDuplex_Polling_Master\\EWARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_Polling_Master.eww</tt>
  -# Select desired configuration to build
...
- \c SPI_FullDuplex_Polling_Master - Release configuration
...
|     DL3    |                             ON: error - Blinking: timeout error                            |
|     DL4    |                                          Not Used                                          |
|     U5     |   Fast blinking: waiting User push-button (PUSH1) - ON: transmission process is complete.  |
...
-------------------------------------------------------------------------
|      PUSH1     |  Start the communication through IT on master board  |
|      PUSH2     |                       Not Used                       |
...
If the Master board is used, the project SPI_FullDuplex_Polling_Master must be used.
If the Slave board is used, the project SPI_FullDuplex_Polling_Slave must be used.
...
- Connect Master board PA5 to Slave Board PA13
- Connect Master board PA7 to Slave Board PA14
- Connect Master board PA12 to Slave Board PA15
...
/* Includes ------------------------------------------------------------------*/
#include "SPI_FullDuplex_Polling_Master_main.h"
