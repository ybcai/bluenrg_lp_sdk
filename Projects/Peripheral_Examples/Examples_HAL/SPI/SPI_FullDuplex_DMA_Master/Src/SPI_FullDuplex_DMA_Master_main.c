...
* File Name          : SPI_FullDuplex_DMA_Master_main.c
...
/**
 * @file  SPI_FullDuplex_DMA_Master/SPI_FullDuplex_DMA_Master_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\SPI\\SPI_FullDuplex_DMA_Master\\MDK-ARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_DMA_Master.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\SPI\\SPI_FullDuplex_DMA_Master\\EWARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_DMA_Master.eww</tt>
  -# Select desired configuration to build
...
- \c SPI_FullDuplex_DMA_Master - Release configuration
...
|     DL3    |                                                 ON: error                                                |
|     DL4    |                                                 Not Used                                                 |
|     U5     |   Fast blinking: waiting User push-button (PUSH1) to be pressed - ON: transmission process is complete.  |
...
---------------------------------------------------------
|      PUSH1     |  Start the communication through IT  |
|      PUSH2     |               Not Used               |
...
If the Master board is used, the project SPI_FullDuplex_DMA_Master must be used.
If the Slave board is used, the project SPI_FullDuplex_DMA_Slave must be used.
...
/* Includes ------------------------------------------------------------------*/
#include "SPI_FullDuplex_DMA_Master_main.h"
