...
* File Name          : SPI_FullDuplex_IT_Master_main.c
...
/**
 * @file  SPI_FullDuplex_IT_Master/SPI_FullDuplex_IT_Master_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\SPI\\SPI_FullDuplex_IT_Master\\MDK-ARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_IT_Master.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\SPI\\SPI_FullDuplex_IT_Master\\EWARM\\{STEVAL-IDB011V1}\\SPI_FullDuplex_IT_Master.eww</tt>
  -# Select desired configuration to build
...
- \c SPI_FullDuplex_IT_Master - Release configuration
...
---------------------------------------------------------------------------------------------------------------------------------------------------------
|     DL1    |                                                                 Not Used                                                                 |
|     DL2    |  Fast blinking: waiting User push-button (PUSH1) to be pressed - ON: transmission process is complete and reception process is complete  |
|     DL3    |                                                                 ON: error                                                                |
|     DL4    |                                                                 Not Used                                                                 |
|     U5     |                                                                 Not Used                                                                 |
